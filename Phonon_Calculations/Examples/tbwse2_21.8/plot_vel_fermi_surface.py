...
na, lat, type_mass, at_types, masses, positions = get_structure_from_lammps('/home/mshinjan/Phonons/MoirePhonons/Force_Constant_Generation/Examples/tblg_21.8/in.phonon')

print(lat,flush=True)
rec_lat = np.linalg.inv(lat.T)*np.pi*2
print(rec_lat,flush=True)
