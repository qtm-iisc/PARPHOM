...
data_file = '/home/mshinjan/Phonons/MoirePhonons/Phonon_Calculations/Examples/tblg_21.8/phbands_21.8_dos.hdf5' 

utils = moire_phonon_utils(lammps_input_file=floc+fname)
utils.read_lammps()
utils.density_of_states(mesh, data_file, nbands, en_range, en_spacing, 
                        method='gaussian',
                        q_grid_file = '/home/mshinjan/Phonons/MoirePhonons/Phonon_Calculations/Examples/tblg_21.8/dos_21.8.dat',
                        full_q_grid_file = '/home/mshinjan/Phonons/MoirePhonons/Phonon_Calculations/Examples/tblg_21.8/full_grid_100X100' ,
